...
public class SecondMapFragment extends BaseCallbacks {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mTextView = (TextView) view.findViewById(R.id.tv_second);
        mTextView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(getContext(), getString(R.string.second_fragment), Toast.LENGTH_SHORT).show();
            }
        });
